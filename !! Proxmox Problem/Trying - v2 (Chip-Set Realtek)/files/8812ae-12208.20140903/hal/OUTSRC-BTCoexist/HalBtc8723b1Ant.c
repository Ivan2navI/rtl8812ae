...
u4Byte	GLCoexVerDate8723b1Ant=20140306;
u4Byte	GLCoexVer8723b1Ant=0x4b;
	...
	)
{
		...
		BTC_PACKET_ARP == type )
	{
		...
		if (BTC_PACKET_ARP == type )
		{
			...
			if (pCoexDm->nAPRCnt >= 10) // if APR PKT > 10 after connect, do not go to ActionWifiConnectedSpecialPacket(pBtCoexist)
				return;
		}
